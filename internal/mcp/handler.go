...
func (h *Handler) handleInitialize(w http.ResponseWriter, req *Request) {
	...
	instructions := RenderServerInstructions(h.cfg.Domain, toolCount, personaCount, skillCount)
